/*
 * Atapi2.h -- Windows CE book-surface header of record (Akari API).
 *
...
#ifndef AKARI_ATAPI2_H
#define AKARI_ATAPI2_H
 ...
 * ------------------------------------------------------------------ */
/* ms901366 INQUIRY_DATA -- HELD (page print; member types unpublished):
 *   typedef struct _INQUIRY_DATA { ... } INQUIRY_DATA, *PINQUIRY_DATA; */

#ifdef __cplusplus
}
#endif

#endif /* AKARI_ATAPI2_H */

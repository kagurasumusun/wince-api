/* Oleauto.h -- documented-case alias for Objbase.h.
 * The Automation Functions pages print Header: Oleauto.h (154 rows
 * in the harvest; plus DISPPARAMS, METHODDATA, PARAMDATA); the

/* Comcat.h -- documented-case alias for Objbase.h.
 * The component categories surface prints Header: Comcat.h (14 rows):
 * ICatInformation/ICatRegister and the CATID/IEnumCATID types are
